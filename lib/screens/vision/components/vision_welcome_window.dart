...
class VisionWelcomeWindow extends StatelessWidget {
  /// Creates a new instance of [VisionWelcomeWindow].
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context)!.visionWelcomeMessage,
