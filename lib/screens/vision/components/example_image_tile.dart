...
/// A container displaying an example image for demonstrating Apple Machine Learning vision features.
///
/// This widget displays an example image that can be used to demonstrate the capabilities of the Apple ML Vision. The
/// image can be displayed in a `selected` state. In this state, a border is drawn around the image. In the unselected
/// state, no border is drawn.
